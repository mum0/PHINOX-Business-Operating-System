/**
  ...
  'CUST-02': {
    ...
    unit: 'count',
    period: PERIOD.MONTHLY,
    formula: 'COUNT(Customers WHERE joinDate IN period AND totalOrders = 1)',
    description: 'Customers who made their first purchase in the period'
  },
  'CUST-03': {
    ...
    unit: 'count',
    period: PERIOD.MONTHLY,
    formula: 'COUNT(Customers WHERE totalOrders > 1)',
  ...
  'CUST-04': {
    ...
    unit: '%',
    period: PERIOD.MONTHLY,
    formula: 'IF(Total Customers > 0, (Returning / Total) * 100, 0)',
    description: 'Percentage of customers who returned for repeat purchases'
  },
  'CUST-05': {
    ...
    unit: 'EGP',
    period: PERIOD.MONTHLY,
    formula: 'SUM(totalAmount) / COUNT(Customers)',
  ...
  'CUST-06': {
    ...
    unit: 'orders',
    period: PERIOD.MONTHLY,
    formula: 'SUM(totalOrders) / COUNT(Customers)',
  ...
  'CUST-07': {
    ...
    unit: 'EGP',
    period: PERIOD.MONTHLY,
    formula: 'IF(New Customers > 0, Marketing Spend / New Customers, 0)',
  ...
  'CUST-08': {
    ...
    description: 'Average customer satisfaction score (manual input)'
  },
  'CUST-09': {
    ...
    description: 'Net Promoter Score from customer surveys (manual input)'
  },
  'CUST-10': {
    name: 'Churn Rate',
    category: CATEGORY.CUSTOMER,
    unit: '%',
    period: PERIOD.MONTHLY,
    formula: 'IF(Total Customers > 0, (Churned / Total) * 100, 0)',
...
const KpiSchema = (function() {
 ...
 unit: 'count',
 period: PERIOD.MONTHLY,
 formula: "COUNT(Tasks WHERE completedAt IS NOT NULL AND completedAt IN period)",
 description: 'Total tasks that reached a terminal state in the period'
 },
 'PERF-02': {
 name: 'Tasks Approved',
 category: CATEGORY.PERFORMANCE,
 unit: 'count',
 period: PERIOD.MONTHLY,
 formula: "COUNT(Tasks WHERE status = 'Approved' AND createdAt IN period)",
 description: 'Tasks approved by reviewer in the period'
 },
 'PERF-03': {
 name: 'Approval Rate',
 category: CATEGORY.PERFORMANCE,
 unit: '%',
 period: PERIOD.MONTHLY,
 formula: "IF(Completed Tasks > 0, (Approved / Completed) * 100, 0)",
 description: 'Percentage of completed tasks that were approved'
 },
 'PERF-04': {
 ...
 unit: 'days',
 period: PERIOD.MONTHLY,
 formula: 'AVERAGE(completedAt - createdAt) for completed tasks',
 ...
 unit: '%',
 period: PERIOD.MONTHLY,
 formula: "IF(Completed Tasks > 0, (On-Time / Completed) * 100, 0)",
 ...
 period: PERIOD.MONTHLY,
 formula: "IF(Total Tasks > 0, (Overdue / Total) * 100, 0)",
 description: 'Percentage of active tasks that are past due date'
 },
 'PERF-07': {
 ...
 unit: '%',
 period: PERIOD.MONTHLY,
 formula: 'AVERAGE(activeTasks / capacity) across active members',
 description: 'Average workload utilization of active team members'
 },
 'PERF-08': {
 name: 'Member Efficiency Score',
 category: CATEGORY.PERFORMANCE,
 unit: 'score',
 period: PERIOD.MONTHLY,
 formula: 'AVERAGE(weightedScore) per completed task across members',
 description: 'Average efficiency score across all members'
 },
 'PERF-09': {
 ...
 unit: 'score',
 period: PERIOD.MONTHLY,
 formula: 'AVERAGE(member weightedScore) by department',
 description: 'Average task performance score by department'
 },
 'PERF-10': {
 ...
 unit: 'score',
 period: PERIOD.MONTHLY,
 formula: 'AVERAGE(quality) for tasks in period',
 description: 'Average quality rating of tasks in the period'
 },
 'PERF-11': {
 ...
 unit: 'score',
 period: PERIOD.MONTHLY,
 formula: 'Standard deviation of task counts across active members',
 description: 'Lower value indicates more balanced workload distribution'
 }
 });
