...
/* ───────────────────────────────────────────
 ...
 if (typeof now !== 'function') {
  ...
  var MEMBER_COL = { MEMBER_ID: 0, FULL_NAME: 1, ROLE: 2, EMAIL: 3, PHONE: 4, STATUS: 5, JOIN_DATE: 6, KPI_SCORE: 7, TASKS_COMPLETED: 8, TASKS_LATE: 9, AVERAGE_QUALITY: 10, NOTES: 11, DEPARTMENT: 12 };
 ...
 function ensureAppConstants(){
  ...
  if(!APP.ROLES){
  APP.ROLES = { ADMIN: "Admin", CEO: "CEO", PARTNER: "Partner", DESIGNER: "Designer", MARKETING: "Marketing", OPERATIONS: "Operations", CUSTOMER_SERVICE: "Customer Service", FINANCE: "Finance" };
  }
  if(!APP.SHEETS){
  APP.SHEETS = {
  ...
  'BOM': { read: PERMISSIONS.INVENTORY_BOM_READ, write: PERMISSIONS.INVENTORY_BOM_MANAGE, delete: PERMISSIONS.INVENTORY_BOM_MANAGE },
 'BOM_ITEM': { read: PERMISSIONS.INVENTORY_BOM_READ, write: PERMISSIONS.INVENTORY_BOM_MANAGE, delete: PERMISSIONS.INVENTORY_BOM_MANAGE },
