 ...
 * PHASE 3A: Added `type` field (column 20) for inventory classification.
 */

const InventorySchema = (function() {
  'use strict';

  // ─── COLUMN MAPPING (20 fields) ───
  ...
  const VALIDATION = Object.freeze({
    ...
    type: { allowed: Object.values(TYPE) }
  });
  ...
  // ─── SHEET HEADERS (for Setup.js canonical integration) ───
